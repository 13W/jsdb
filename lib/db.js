...
Db.prototype = {
    ...
    getCollection       :   function(collectionName, options) {
        ...
        if (!this.Storage.exists(collectionName)) {
            ...
            var collection = this.collections[collectionName] = this.collections[collectionName] || new Collection(collectionName, options);
        ...
        if (!options.fake) this.createDotPath(collectionName);
