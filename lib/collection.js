...
function Collection(collectionName, options) {
    ...
    self.setDb = function(db) {
        self.db = db;
        self.indexes = self.db.getCollection('system.indexes');
    };
}

Collection.prototype = {
    new             :   function(collectionName, options) {
        collectionName = collectionName + '.' + utils.uuid.uuidFast();
        var collection = this.db.getCollection(collectionName, options);
